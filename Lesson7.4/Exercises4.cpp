...
public:
	...
	bool update(Student s) {
		int index = findNodeIndex(s);
		if (index >= 0) {
			data[index].setGpa(s.getAvg());
			int parentIndex = (index - 1) / 2;
...
int main() {
	...
	do
	{
		...
		cout << "4. Cap nhat sinh vien co ma x.\n";
		cout << "5. Xoa sinh vien co ma x.\n";
		cout << "6. Cho biet sinh vien co ma nho nhat trong heap.\n";
		cout << "7. Cho biet so luong sv hien co trong heap.\n";
